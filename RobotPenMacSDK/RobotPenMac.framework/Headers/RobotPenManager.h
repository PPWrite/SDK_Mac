...
/*!
 ...
 @param model SDK模式
 */
- (void)setMACSDKModel:(RobotPenMACSDKModel)model;
...
/*!
 @method
 @abstract 是否自动纠正点阵纸的偏移，包括：纸张偏移、设备工装偏移。默认为true
 @param isAuto 是否自动
 */
- (void)setAutoCorrectLatticePaperOffset:(BOOL)isAuto;

/*!
 @method
 @abstract 定义点阵纸的类型和范围，在x10系列设备用，类型详情请看 RobotLatticePaperType。rangRect 和 paperSize 参数仅仅在 type == RobotLatticePaperType_Custom 时需要设置，其他情况请传CGRectZero/CGSizeZero.
 @param type 点阵纸的类型，默认为 RobotLatticePaperType_Default
 @param rangRect 自定义点阵纸裁剪范围
 @param paperSize 自定义点阵裁剪每张纸的大小，width 和 height 必须能整除 rangRect 中的 width 和 height，否则可能出现页码计算不正确的问题
 */
- (void)setLatticePaperType:(RobotLatticePaperType)type
...
/*!
 ...
 @result 返回结果
 */
- (nullable RobotPenDevice *)getConnectDevice;
...
/*!
 ...
 @result 返回结果
 */
- (nullable NSArray *)getDeviceSearchList;
...
/*!
 ...
 @result 返回结果
 */
- (nullable NSArray *)getPairingDevice;
...
/*!
 @method
 @abstract 设置P1设备版本,默认为YES
 @discussion USB（P1）专用
 @param isNew 是否是新版本
 */
