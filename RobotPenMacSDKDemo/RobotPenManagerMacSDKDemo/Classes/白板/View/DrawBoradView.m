...
{
    RobotPenUtilPoint *oPoint = [RobotPenUtilPoint new];
    oPoint.optimizeX = point.originalX;
    oPoint.optimizeY = point.originalY;
    oPoint.deviceType = point.deviceType;
    oPoint.touchState = point.touchState;
    oPoint.width = 1;
    [self drawOptimizesPoint:oPoint];
}
/**
 绘制优化笔迹
